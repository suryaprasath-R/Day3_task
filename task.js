// FOR THE GIVEN JSON ITERATE THE OVERALL LOOP (for, for in, for of, for each)
...
for (let output of array) {
    console.log(output.id, output.name, output.email);
};

array.forEach(element => console.log(element.id, element.name, element.email));